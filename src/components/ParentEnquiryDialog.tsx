...
export const ParentEnquiryDialog = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        ...
        { ...formData, sheetName: "hero_enquiry" }
      );
      setStatus("success");
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl text-black shadow-xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <p className="text-gray-600 mb-4">
          Fill in your details and we’ll help you find the nearest EduTransform schools.
        </p>
