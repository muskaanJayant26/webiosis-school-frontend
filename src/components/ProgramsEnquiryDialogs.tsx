...
export const ProgramsEnquiryDialog = ({ isOpen, onClose, programs }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        ...
        { ...formData, sheetName: "programs_enquiry" }
      );
      setStatus("success");
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl text-black shadow-xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Program Enquiry</h2>
        <p className="text-gray-600 mb-4">
          Fill in your details and we’ll get back to you with more information about our programs.
        </p>
