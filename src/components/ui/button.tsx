  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground shadow-button transform hover:scale-105 hover:!bg-white text-black hover:!text-black hover:shadow-green",
        ghost: "hover:!bg-white hover:!text-black hover:shadow-green",
        link: "text-primary underline-offset-4 hover:underline hover:text-primary-glow",
        hero: "bg-gradient-hero text-primary-foreground shadow-glow hover:!bg-white hover:!text-white hover:shadow-green transform hover:scale-105",
        accent: "bg-gradient-accent text-accent-foreground shadow-button hover:!bg-white hover:!text-black transform hover:scale-105",
      },
      size: {
