...
export const SchoolUpgradeEnquiryDialog = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        ...
        { ...formData, sheetName: "school_upgrade_enquiry" }
      );
      setStatus("success");
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl text-black shadow-xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">
          School Upgrade Enquiry
        </h2>
        <p className="text-gray-600 mb-4">
          Fill in your details and we’ll contact you with more information about our School Upgrade Pack.
        </p>
