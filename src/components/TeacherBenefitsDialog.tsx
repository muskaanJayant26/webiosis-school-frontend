...
export const TeacherBenefitsDialog = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        ...
        { ...formData, sheetName: "teacher_benefits" }
      );
      setStatus("success");
      setFormData({
        teacherName: "",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl text-black shadow-xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <p className="text-gray-600 mb-4">
          Fill out the form and discover how EduTransform can empower your teaching.
        </p>
